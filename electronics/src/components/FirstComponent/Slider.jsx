  ...
  return (
    <div>
      <section id="mbeshtjellesi-kartave" className="mbeshtjellesi-kartave">
        <div id="kartat-e-medha" className="kartat-e-medha">
            ...
            <div className="kartaMadhe-kutiaInfos">
              ...
              <div className="kartaMadhe-infoDyte">
                ...
                <p>
                  ...
                  dolor sit, amet consectetur adipisicing elit. Debitis quos eum
          ...
          {/*          fundi i kartes se pare shenim kot per qef sssssssssssssssssssssss      */}
