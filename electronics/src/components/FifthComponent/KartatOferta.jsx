  ...
  return (
    <div style={{padding: '2rem 11%' }}>
      ...
      <div id="background-kartave-klub" className="backgroundi-karta-klub">
        <div id="kartat-e-medha-klub" className="kartat-e-medha">
      ...
      <section id="butonat-e-kontrolluesit-klub" className="butonat-e-kontrolluesit">
        <button id="majtas-klub"> <i className="fa-solid fa-chevron-left"></i> </button>
        <button id="djathtas-klub"> <i className="fa-solid fa-chevron-right"></i> </button>
      </section>
    ...
    <div>
      <div className="kartaMadhe">
        <div className="kartaMadhe-foto">
          <img src="https://cms-images.mmst.eu/hzxov1nxpus5/71nYeekJh3cEIXITzylCen/2d4a6375488efbaf7e0d52b1a1e13d3d/teaser_web.jpg?q=88&w=658" alt="" draggable="false"/>
        </div>
        ...
        <div className="kartaMadhe-kutiaInfos">
          ...
          <div className="kartaMadhe-infoDyte">
            ...
            <p> Per cdo blerje Samsung Galaxy Z FOLD6/ Z FLIP6 Lorem ipsum dolor sit, amet consectetur adipisicing elit. Debitis quos eum voluptatum molestias delectus</p>
